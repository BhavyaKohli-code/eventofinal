...
const validUsername = "Package"; // Replace with your actual username
const validPassword = "###eventoeasy###"; // Replace with your actual password
...
export default function Login({ onLogin }) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Package Manager Login</Text>
      <TextInput
        style={styles.input}
...
const styles = StyleSheet.create({
  ...
  passwordContainer: {
    ...
    marginBottom: 10,
    borderRadius: 5,
    width: '100%', // Make password container take full width
  },
  passwordInput: {
    flex: 1,
    height: 40,
